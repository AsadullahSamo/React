...
export default function Text(props) {
    ...
    const val = [];
    for(let j=0; j<props.inputVal; j++){
      val.push(<p key={j} className='text-[16px] text-[#0f172a] leading-8 w-[50%]'>{texts[j]}</p>);
    } 
